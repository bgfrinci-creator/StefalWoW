...
enum CharacterDatabaseStatements : uint32
{
    ...
    */
    ...
    CHAR_SEL_CHARACTER_ARENA_STATS,
    ...
    CHAR_UPD_CHAR_TIMERUNNING_SEASON,
    CHAR_SEL_CHAR_TIMERUNNING_SEASON,
    CHAR_SEL_CHAR_INVENTORY_ITEM_ENTRIES,
    CHAR_UPD_CHAR_ADD_FLAGS4,
    CHAR_INS_BUG_REPORT,
    ...
    CHAR_REP_PERKS_CURRENCY,
    CHAR_SEL_PERKS_PURCHASES,
    CHAR_INS_PERKS_PURCHASE,
    CHAR_SEL_PERKS_FROZEN,
    CHAR_REP_PERKS_FROZEN,
    CHAR_DEL_PERKS_FROZEN,
    CHAR_SEL_PERKS_MILESTONES,
    CHAR_INS_PERKS_MILESTONE,
    CHAR_DEL_PERKS_MILESTONES,
